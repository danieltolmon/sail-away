...
describe('logic', () => {
    ...
    describe.only('create Journeys', () => {
        ...
        it.only('should succeed on valid data', () => {
            ...
            Journey.findById(id).select('-__v').lean()
                .then(journey => {
        ...
        it.only('should fail in user not autorized', () => {
        ...
        it.only('should fail on empty title', function () {
            let title = ''
        ...
        it.only('should fail on title not being string', function () {
            let title = 123
        ...
        it.only('should fail on empty seaId', function () {
            let seaId = ''
        ...
        it.only('should fail on seaId not being string', function () {
            let seaId = 123
        ...
        it.only('should fail on empty route', function () {
            let route = []
        ...
        it.only('should fail on route not being string', function () {
            let route = 123
        ...
        it.only('should fail on empty dates', function () {
            let dates = []
        ...
        it.only('should fail on dates not being string', function () {
            let dates = 123
        ...
        it.only('should fail on empty description', function () {
            let description = ''
        ...
        it.only('should fail on description not being string', function () {
            let description = 123
        ...
        it.only('should fail on userId not being string', function () {
            let userId = 123
        ...
        it.only('should fail on empty boat', function () {
            let boat = {}
        ...
        it.only('should fail on boat not being string', function () {
            let boat = 123
        ...
        it.only('should fail on empty lookingFor', function () {
            let lookingFor = {}
        ...
        it.only('should fail on lookingFor not being string', function () {
            let lookingFor = 123
